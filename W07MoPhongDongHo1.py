import turtle
import time
#             BẢNG NÀY CÓ LỖI NHƯNG VẪN DÙNG ĐƯỢC, BẢNG 2 HOÀN CHỈNH HƠN
class Clock:
    def __init__(self, hour, minute, second):
        ...
        self.screen.tracer(0)  # Tắt cập nhật tự động đê màn hình chạy mượt.
    ...
    def start_clock(self):
        ...
        while True: ########################             gây lỗi đa luồng
            ...
            # xóa các kim # đặt màu các kim trùng màu đồng hồ
            self.draw_clock_hands()

            #Tăng giây đồng hồ lên 1 đơn vị.
            self.second+=1
